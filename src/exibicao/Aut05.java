...
public class Aut05 extends javax.swing.JFrame {

    public Aut05() {
        initComponents();
        Can05 can05 = new Can05();
        this.jPanel2.add(can05);
    ...
    private void btnBaixoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBaixoActionPerformed
        Aut04 aut04 = new Aut04();
        aut04.setVisible(true);
    ...
    private void btnCimaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCimaActionPerformed
        Aut06 aut06 = new Aut06();
        aut06.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aut05.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
