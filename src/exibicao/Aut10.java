...
public class Aut10 extends javax.swing.JFrame {

    public Aut10() {
        initComponents();
        Can10 can10 = new Can10();
        this.jPanel2.add(can10);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aut10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
