...
public class Aut07 extends javax.swing.JFrame {

    public Aut07() {
        initComponents();
        Can07 can07 = new Can07();
        this.jPanel2.add(can07);
    ...
    private void btnBaixoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBaixoActionPerformed
        Aut08 aut08 = new Aut08();
        aut08.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aut07.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
